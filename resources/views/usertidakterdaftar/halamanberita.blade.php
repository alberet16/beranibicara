...
@if ($indexberita)
    ...
    <div class="container content">
      <h1>{{ $indexberita->judul }}</h1>
      <p class="fw-medium">Dibuat pada Dibuat pada {{ $indexberita->created_at }}</p>

      <div class="text-center py-5">
        <img src="/image/{{ $indexberita->image }}" width="500px" alt="" />
      </div>
      <p>
      {{ $indexberita->keterangan }}
      </p>
    </div>
