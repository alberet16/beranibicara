...
<body>
    ...
    <div class="container-fluid contenedor ">
        <h1 class="text-left">Pendidikan Seksual</h1>
        <p>
        Pengetahuan mengenai seks harus di tanam sejak dini. Selain berguna untuk pengetahuan, edukasi ini akan membantu dalam menjaga diri sindiri dan pengetahuan mengenai apa saja yang harus di perkatikan mengenai seks. Jelajahi dan baca beberapa artikel berikut ini!
        </p>
        <br><br>
        <div class="row">
    ...
    <div class="col-lg-6 col-md-6 text-center">
        <form action="/pendidikan/search" method="GET">
        ...
        @if($indexpendidikan->isEmpty())
            <h2 class="text-center">Belum Ada Data</h2>
        @else
        <div class="row">
             @foreach ($indexpendidikan as $data)
           ...
           <div class="card-deck pb-3">
                <div class="card">
                   ...
                   <small>Dibuat pada {{ $indexpendidikan->created_at }}</small>
                    <p><a href="{{ url('/pendidikan/data/' . $data->id) }}">Baca Selengkapnya</a></p>
                    </div>
                </div>
           </div>
           </div> 
