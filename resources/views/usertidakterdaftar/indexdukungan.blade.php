...
<body>
    ...
    <div class="col-lg-6 col-md-6 text-center">
        <form action="/dukungan/searchdukungan" method="GET">
        ...
        <div class="row"> 
           ...
           <div class="card-deck pb-3">
                <div class="card">
                   ...
                   <small>Dibuat pada {{ $data->created_at->formatLocalized('%A, %d %B %Y') }}</small>
                    <p><a href="{{ url('/dukungan/data/' . $data->id) }}">Baca Selengkapnya</a></p>
                    </div>
                </div>
           </div>
           </div> 
