              ...
              <div class="row">
                 <div class="col-xs-12 col-sm-12 col-md-12">
                     <div class="form-group">
                         <strong>Judul</strong>
                         <input type="text" name="judul" value="{{ $superberitum->judul }}" class="form-control" placeholder="Judul">
                         @error('judul')
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-12">
                     <div class="form-group">
                         ...
                         <textarea rows="5" cols="33" name="keterangan" value="{{ $superberitum->keterangan }}"  class="form-control"  placeholder="Keterangan">{{ $superberitum->keterangan }}</textarea>
                         @error('keterangan')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
