...
<body>
    ...
    <div class="container-fluid contenedor ">
        <h1 class="text-left">Berita</h1>
        <p>
        Beberapa berita mengenai perempuan dan anak yang dapat kamu baca untuk menambah wawasan dan berita terkini. Baca selengkapnya dan pelajari lebih lanjut berita mengenai perempuan dan anak!
         ...
         <div class="row"> 
            ...
            <div class="col-lg-6 col-md-6 text-center">
                <form action="/masyarakat/berita/search" method="GET">
           ...
           <div class="card-deck pb-3">
                <div class="card">
                   ...
                   <small>{{ $data->created_at }}</small>
                    <p><a href="{{ url('/masyarakat/berita/data/' . $data->id) }}">Baca Selengkapnya</a></p>
                    </div>
                </div>
           </div>
           </div> 
