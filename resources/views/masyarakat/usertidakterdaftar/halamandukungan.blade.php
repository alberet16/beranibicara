...
<h1>{{ $indexkategoridukungan->judul }}</h1>
<p class="fw-medium">Dibuat pada {{ $indexkategoridukungan->created_at }}</p>

<div class="text-center py-5">
<img src="/image/{{ $indexkategoridukungan->image }}" width="500px" alt="" />
</div>
<p>
{{ $indexkategoridukungan->keterangan }}
</p>
</div>
