...
class UserSignedController extends Controller
{
    //Berita
    public function indexberita(){
        ...
        return view ('masyarakat.usertidakterdaftar.berita',compact('indexberita'));
    }
    ...
    if ($indexberita) {  
        return view('masyarakat.usertidakterdaftar.halamanberita', ['indexberita' => $indexberita]);
    } else {
    ...
    public function indexkategoridukungan(){
        ...
        return view ('masyarakat.usertidakterdaftar.dukungan',compact('indexkategoridukungan'));
    ...
    public function dukungan(Request $request, $id){
        ...
        return view ('masyarakat.usertidakterdaftar.indexdukungan',compact('kategoridukungan','indexkategoridukungan'));
    }
    ...
    public function showdukungan($id)
    {
        ...
        if ($indexkategoridukungan) {
            ...
            return view('masyarakat.usertidakterdaftar.halamandukungan', ['indexkategoridukungan' => $indexkategoridukungan]);
        } else {
            // Jika data tidak ditemukan, tampilkan pesan error atau redirect ke halaman lain
            return redirect()->back()->with('error', 'Data not found.');
        }
    ...
    public function searchdukungan(Request $request)
    {
        ...
        return view ('masyarakat.usertidakterdaftar.indexdukungan',compact('indexkategoridukungan'));
    }
    ...
    public function indexkategoriacara(){
        ...
        return view ('masyarakat.usertidakterdaftar.acara',compact('indexkategoriacara'));
    ...
    public function acara(Request $request, $id){
        ...
        return view ('masyarakat.usertidakterdaftar.indexacara',compact('kategoriacara','indexkategoriacara'));
    }
    ...
    public function searchacara(Request $request)
    {
        ...
        return view ('masyarakat.usertidakterdaftar.indexacara',compact('indexkategoriacara'));
    }
    ...
    if ($indexkategoriacara) {
        // Jika data ditemukan, tampilkan view dengan data tersebut
        return view('masyarakat.usertidakterdaftar.halamanacara', ['indexkategoriacara' => $indexkategoriacara]);
    } else {
        // Jika data tidak ditemukan, tampilkan pesan error atau redirect ke halaman lain
        return redirect()->back()->with('error', 'Data not found.');
    }
    ...
    public function indexkategorinomor(){
        ...
        return view ('masyarakat.usertidakterdaftar.indexnomor',compact('indexkategorinomor'));     
    }
    ...
    public function nomor(Request $request, $id){
        ...
        return view ('masyarakat.usertidakterdaftar.halamannomor',compact('kategorinomor','indexkategorinomor'));
    }
    ...
    public function searchnomor(Request $request)
    {
        ...
        return view ('masyarakat.usertidakterdaftar.halamannomor',compact('indexkategorinomor'));
    }
    ...
    public function indexpendidikanseksual(){
        ...
        return view('masyarakat.usertidakterdaftar.indexpendidikan', compact('indexpendidikan'));
    }
    ...
    if ($indexpendidikan) {
        // Jika data ditemukan, tampilkan view dengan data tersebut
        return view('masyarakat.usertidakterdaftar.halamanpendidikan', ['indexpendidikan' => $indexpendidikan]);
    } else {
        // Jika data tidak ditemukan, tampilkan pesan error atau redirect ke halaman lain
        return redirect()->back()->with('error', 'Data not found.');
    }
    ...
    public function indextentangkami(){
        ...
        return view ('masyarakat.usertidakterdaftar.tentangkami',compact('indextentangkami'));     
    }

    public function indexfasilitas(){
        $indextentangkami = Tentang::all();
        return view ('masyarakat.usertidakterdaftar.fasilitas');     
    }

    public function indexrumahaman(){
        return view ('masyarakat.usertidakterdaftar.rumahaman');
    }
}
